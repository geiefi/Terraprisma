...
export const {
  ...
  Timer_3,
  LeakRemove,
  '60fpsSelect': SixtyFpsSelect,
  BlurOff,
  '30fpsSelect': ThirtyFpsSelect,
  PermCameraMic,
  MicExternalOff,
  TrailLengthMedium,
  CameraRear,
  ...
  Battery_90,
  WifiCalling_2,
  '4gPlusMobiledata': FourGPlusMobileData,
  MediaBluetoothOn,
  NetworkLocked,
  SignalCellularOff,
  Battery_80,
  ...
  MagnifyFullscreen,
  SplitscreenLeft,
  '1xMobiledataBadge': OneXMobileDataBadge,
  KeyboardOff,
  ScreenRecord,
  ...
  MagnifyDocked,
  SplitscreenRight,
  '5gMobiledataBadge': FiveGMobileDataBadge,
  BacklightLow,
  BatteryPlus,
  ...
  ScreenshotKeyboard,
  WallpaperSlideshow,
  '3gMobiledataBadge': ThreeGMobileDataBadge,
  '4gMobiledataBadge': FourGMobileDataBadge,
  BacklightHigh,
  BatteryChange,
  BatteryError,
  BatteryShare,
